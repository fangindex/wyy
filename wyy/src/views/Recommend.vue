<template>
  <div class="Recommend">
    ...
    <RecommendPlayList :currentRecommends="currentRecommends" v-show="!$root.isShowLoading"
      >推荐歌单</RecommendPlayList
    >
    <RecommendNewMusic
      v-show="!$root.isShowLoading"
      :pause="$attrs.pause"
      @translate-music="$emit('translate-music', $event)"
      :class="{ RecommendActive: $attrs.currentMusic }"
      :newSongs="newSongs"
      :currentMusic="$attrs.currentMusic"
      @translate-index="$emit('translate-index', $event)"
